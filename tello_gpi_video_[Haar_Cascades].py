...
def stream():
    ...
    lync = 'C:\opencv\sources\data\haarcascades\\'
    face_cascade = cv2.CascadeClassifier(lync + 'haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier(lync + 'haarcascade_eye.xml')
    count = 0
    c_max = 4
    while True:
